...
async def unit(ctx, name: str):
    ...
    with open('tmgc/tmgc unit.csv', newline='', encoding="utf-8-sig") as csvfile:
...
def get_unit_names(ctx):
    names = ["Blair","Arin","Kenneth","Natasia","Stefan","Desmond","Sam","Josef","Peggy","Butch","Cassius","Rachael","Emile","Jeff","Apollo","Bechamel","Sveltzalus","Hilbert","Agnes","Flynn","Mikey","Carbon","Athena","Charley","Zeke","Hyperius","Alexis","Leila","Damien","Zacharias","Avan","Toddsworth","Yuyu","Artemis","Hollandaise","Vladmir","Dracopope","Horatio","Simone","Viridian","Freddric","Dean","Eliza","Chartreuse","Rift","Estelle","Rose","Dirk","Callum","Manfred","Wilhelm","Argent","Ptolemy","Johan","Peter","Clarque","Sonia","Joan","Tobias","Laronde","Ian","Olsen","Elcorian"]
    names.sort()
