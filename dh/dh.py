...
def get_unit_pages(row):
    unitembed=discord.Embed(title=row['Name'] + " " + row['Affinity'], color=0xe64432)
    supportembed=discord.Embed(title=row['Name'] + " " + row['Affinity'], color=0xe64432)
...
async def unit(ctx, name: str, levels: str = None):
    ...
    Usage:
        ...
        /unit [name] [level] - Show average stats at level (e.g., /unit You 10)
        /unit [name] [level]/[level] - Show average stats after promotion (e.g., /unit Lawrence 10/5)
        /unit [name] [level]/[level] [class] - Show stats with specific promotion (e.g., /unit Lawrence 10/5 Captain)
    """
